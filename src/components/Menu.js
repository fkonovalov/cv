...
import IconBurger from './Icons/IconBurger.js';
...
const Nav = styled.nav`
  ...
  background-color: ${props =>
    props.isOpen
      ? props.theme.menu.mobile.opened.bg
      : props.theme.menu.mobile.closed.bg};
...
export const MenuLink = styled(Link)`
  ...
  color: ${props =>
    props.selected
      ? props.theme.menu.mobile.a.active.color
      : props.theme.menu.mobile.a.color};
  &:hover {
  ...
  ${media.md`
      ...
      color: ${props =>
    props.selected
      ? props.theme.menu.desktop.a.active.color
      : props.theme.menu.desktop.a.color};
      &:hover {
